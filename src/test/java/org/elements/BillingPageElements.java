...
public class BillingPageElements extends BaseClass {
	...
	public void nonTaxableAddressDropdown() {
	...
	// To select International Address
	public void internationalAddressDropdown() {

		WebElement savedAdd = driver.findElement(By.id("dwfrm_singleshipping_addressList"));

		Select a = new Select(savedAdd);
		a.selectByValue("International");
	}
	...
	public void monthDropdown() {
		...
		WebElement month = driver
				.findElement(By.xpath("//select[@id='dwfrm_billing_paymentMethods_creditCard_expiration_month']"));
	...
	public void yearDropdown() {
		...
		WebElement year = driver
				.findElement(By.xpath("//select[@id='dwfrm_billing_paymentMethods_creditCard_expiration_year']"));
	...
	// To check the required field error
	@FindBy(xpath = "//span[@id='dwfrm_billing_paymentMethods_creditCard_number-error']")
	public WebElement requiredFieldError;

	// To check the error message for invalid details
	@FindBy(xpath = "//h1[text()='An Error Occurred!']")
	public WebElement invalidError;

	// To check the Addresses
	@FindBy(xpath = "(//div[@class='address'])[1]")
